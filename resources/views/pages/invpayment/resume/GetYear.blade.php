    ...
    <div class="card h-100">
        <div class="card-header pb-0 d-flex justify-content-between mb-lg-n4">
            <div class="card-title mb-0">
                <h5 class="mb-0">Resume <b>Tahun {{ $from }}</b> </h5>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="earningReportsId">
                    <a class="dropdown-item" href="{{ route('invpayment-resume.index') }}">Reset</a>
                </div>
            </div>
            <!-- </div> -->
        </div>
        ...
        <div class="card-body">
            <div class="row ">
                <div class="col-auto me-auto ">
                    <h5 class="mb-0">Statistic Invoice & Pembayaran <b>Tahun {{ $from }}</b> </h5>
                </div>
            </div>
