...
<div class="col-xl-12">
    <div class="card">
        <form action="{{ route('form-checkedman.update', $edit->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="col-12 text-center mt-0 pt-20 mb-4">
                <a href="{{ route('form-checkedman.index') }}" class="btn btn-outline-secondary me-1">Back</a>
