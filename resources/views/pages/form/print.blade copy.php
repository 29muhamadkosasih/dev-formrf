        ...
        <table class="table table-bordered tab mt-4">
            ...
            <tbody>
                ...
                <tr style="color:black; background-color: lightgreen">
                    <th colspan="9" style="text-align :right ">TOTAL CASH</th>
                    <td style="text-align :right"> {{ number_format($jumlah_total, 0, ',',
                        '.') }}</td>
                </tr>
                <tr style="color:black; background-color: lightgreen">
                    <th colspan="9" style="text-align :right ">TOTAL TRANSFER </th>
                    <td style="text-align :right"> {{ number_format($jumlah_total2, 0, ',',
                        '.') }}</td>
                </tr>
                <tr style="color:black; background-color: lightgreen">
                    <th colspan="9" style="text-align :right ">TOTAL BIAYA TRANSFER </th>
                    <td style="text-align :right"> {{ number_format($jumlah_admin, 0, ',',
                        '.') }}</td>
                </tr>
                <tr style="color:black; background-color: lightgreen">
                    <th colspan="9" style="text-align :right ">JUMLAH TOTAL </th>
