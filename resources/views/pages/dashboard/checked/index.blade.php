                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-column">
                            ...
                            <div class="chart-statistics">
                                <h3 class="card-title mb-1">{{ number_format($jumlah_total_tti, 0, ',', '.',)
                                    }}
                                </h3>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-column">
                            ...
                            <div class="chart-statistics">
                                <h3 class="card-title mb-1">Rp.
                                    {{ number_format($jumlah_total_bulan_tti, 0, ',', '.',) }} /
                                    {{
                                    $namaBulan }}</h3>
                            </div>
                        </div>
