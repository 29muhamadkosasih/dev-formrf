$(document).ready(function () {
    ...
    $("#toggle").on("click", function () {
        tableContainer.css("display", visible ? "none" : "block"), tableHideHeader.fixedHeader.adjust(), visible = !visible
    });
    ...
    $(function () {
        function resize() {
            setTimeout(function () {
                dataexFixhBasic.draw(), tableEnablDeisable.draw(), tableHideHeader.draw(), tableResponsive.draw(), tableResponsiveBootstrap.draw(), tableColReorder.draw()
            }, 400)
        }
